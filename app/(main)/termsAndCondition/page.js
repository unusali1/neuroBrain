...
const TermsAndCondition = () => {
    return (
        <div className="sm:mt-16 mt-8 px-6 sm:px-28 mb-16">
            <h2 className="text-4xl font-bold text-cyan-400 mb-12">TERMS AND SERVICE</h2>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                You agree to use our Services in accordance with all applicable laws. You are prohibited from using the Services to engage in unlawful activities, harassment, or any other conduct that may cause harm to individuals or organizations.
            </p>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                We respect your privacy. By using our Services, you acknowledge that you have read and understood our Privacy Policy. This outlines how we collect, use, and protect your information.
            </p>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                You may be required to create an account to use certain features of the Services. You are responsible for maintaining the confidentiality of your account information, and you agree to notify us immediately of any unauthorized use of your account.
            </p>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                We may terminate or suspend your access to the Services if you breach these Terms or if we believe it is necessary to protect the integrity of the platform. You can also terminate your use of the Services at any time by contacting our customer support.
            </p>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                These Terms are governed by and construed in accordance with the laws of [Your Country/State]. Any disputes will be resolved in the competent courts of [Your Jurisdiction]. You agree to submit to the jurisdiction of these courts in case of legal actions.
            </p>
            ...
            <p className="text-gray-700 mb-6 text-justify">
                Email: hi.neurobrains@gmail.com
            </p>
            <p className="text-gray-700 mb-6 text-justify">
            ...
            <p className="text-gray-700 mb-6 text-justify">
                If any provision of these Terms is found to be unlawful, void, or unenforceable, such provision will be deemed severable from these Terms and will not affect the validity and enforceability of the remaining provisions.
            </p>
